...
"""Tests for emcomunication_at_scale.ease_of_learning."""

from absl.testing import absltest
from jaxline import platform, train, utils

from noisy_emcom.configs import ease_of_learning_config, lewis_config
...
class EaseOfLearningTest(absltest.TestCase):
    def test_ease_learning(self):
        ...
        train.train(lewis_experiment.LewisExperiment, config, checkpointer, writer)
        ...
        train.train(
            eol_experiment.EaseOfLearningExperiment, config, checkpointer, writer
        )  # Uses same checkpointer and writer.
