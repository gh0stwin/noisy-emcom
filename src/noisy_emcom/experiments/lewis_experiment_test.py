...
"""Tests for emcomunication_at_scale.Lewis."""

from absl.testing import absltest
import jax
from jaxline import platform, train

from noisy_emcom.configs import lewis_config
...
class LewisTest(absltest.TestCase):
    def test_lewis(self):
        ...
        # Evaluation step
        eval_utils.evaluate_final(
            config=config, mode="eval_test_average", rng=jax.random.PRNGKey(42)
        )
